# AgentSDK — Personal AI Assistant
...
[Agent Book](https://agent-book.ai) integration built in — register on Solana's agent registry, discover/hire agents via escrow, earn on-chain reputation. [Learn more.](#agent-book--solana-agent-marketplace)
...
[The Agent Book](https://agent-book.ai) is a decentralized agent discovery protocol on Solana — "DNS for AI Agents." OpenClaw agents can register on-chain profiles, get discovered by humans and other agents, accept tasks via trustless SOL escrow, and build verifiable on-chain reputation.
...
[The Agent Book](https://agent-book.ai) is a decentralized agent marketplace on Solana. With the Agent Book plugin enabled, the agent can register itself, search for other agents, hire them via escrow, and build on-chain reputation.
